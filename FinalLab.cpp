...
void variableCheck()
{
    out<<endl<<"**********Variable Checking************"<<endl;
     ifstream input("C:\\Users\\sagor\\OneDrive\\Desktop\\Coding\\Compiler Lab\\read.txt");
    while(getline(input,line))
            {
...
There:
                                ...
                                if(flag == 0)
                                {
                                    ...
                                    {
                                        out<<store<<"\t"<<newStore<<"\t Valid";
                                        out<<endl;
                                        newStore="";
                                    }
                                    else
                                    {
                                        out<<store<<"\t"<<newStore<<"\t Invalid";
                                        out<<endl;
                                        newStore="";
                                    }
...
void KeywordCheck()
{
            word = "",count=1,k=0;
            ifstream input("C:\\Users\\sagor\\OneDrive\\Desktop\\Coding\\Compiler Lab\\read.txt");
            out<<endl<<"**********Keyword Checking************"<<endl;
            out<<"Keyword List: "<<endl;

            while(getline(input,line))
            {
                out<<endl<<"Line No: "<<count<<endl;
                count++;
                for(i=0; i<=line.size(); i++)
                {
...
{
    ifstream input("C:\\Users\\sagor\\OneDrive\\Desktop\\Coding\\Compiler Lab\\read.txt");
    out<<endl<<"**********Special Symbol List************"<<endl;
     while (getline(input, line))
            {
